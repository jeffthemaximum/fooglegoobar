...
# to piece together any excess panel material into more squares.
...
# Write a function answer(area) that takes as its input a single unit of measure representing the
# total area of solar panels you have (between 1 and 1000000 inclusive) and
...
def least_sqrt(a):
    while a > 0:
        least_sqrt = int(math.floor(math.sqrt(a))**2)
        a = a - least_sqrt
        yield least_sqrt

def answer(a):
    return [a for a in least_sqrt(a)]
